    ...
    if (YTPlayer.opt.optimizeDisplay) {
      ...
      vid.height =
        YTPlayer.opt.ratio == "16/9"
          ? Math.ceil(win.width * (9 / 16))
          : Math.ceil(win.width * (3 / 4));
      ...
      if (lowest) {
        ...
        vid.width =
          YTPlayer.opt.ratio == "16/9"
            ? Math.floor(win.height * (16 / 9))
            : Math.floor(win.height * (4 / 3));
  ...
  (e.simpleSlider = {
    ...
    init: function (o) {
      return this.each(function () {
        var a = this,
          l = e(a);
        l.addClass("simpleSlider"),
          (a.opt = {}),
          e.extend(a.opt, e.simpleSlider.defaults, o),
          e.extend(a.opt, l.data());
        ...
        l.prepend(n),
          ...
          l.updateSliderVal(),
          a.opt.readonly ||
            (l.on(e.simpleSlider.events.start, function (e) {
              t && (e = e.changedTouches[0]),
                (a.canSlide = !0),
                l.updateSliderVal(e),
                l.css({ cursor: "col-resize" }),
                e.preventDefault(),
                e.stopPropagation();
            }),
            e(document)
              .on(e.simpleSlider.events.move, function (o) {
                t && (o = o.changedTouches[0]),
                  a.canSlide &&
    ...
    updateSliderVal: function (t) {
      ...
      if (l.opt) {
        l.opt.initialval =
          "number" == typeof l.opt.initialval
            ? l.opt.initialval
            : l.opt.initialval(l);
        ...
        (l.x =
          "object" == typeof t
            ? t.clientX + document.body.scrollLeft - a.offset().left
            : "number" == typeof t
            ? (t * i) / l.opt.scale
            : (l.opt.initialval * i) / l.opt.scale),
          (l.y =
            "object" == typeof t
              ? t.clientY + document.body.scrollTop - a.offset().top
              : "number" == typeof t
              ? ((l.opt.scale - l.opt.initialval - t) * n) / l.opt.scale
              : (l.opt.initialval * n) / l.opt.scale),
          (l.y = a.outerHeight() - l.y),
          (l.scaleX = (l.x * l.opt.scale) / i),
          (l.scaleY = (l.y * l.opt.scale) / n),
          (l.outOfRangeX =
            l.scaleX > l.opt.scale
              ? l.scaleX - l.opt.scale
              : l.scaleX < 0
              ? l.scaleX
              : 0),
          (l.outOfRangeY =
            l.scaleY > l.opt.scale
              ? l.scaleY - l.opt.scale
              : l.scaleY < 0
              ? l.scaleY
              : 0),
          (l.outOfRange =
            "h" == l.opt.orientation ? l.outOfRangeX : l.outOfRangeY),
          "undefined" != typeof t
            ? (l.value =
                "h" == l.opt.orientation
                  ? l.x >= a.outerWidth()
                  ...
                  ? 0
                  : l.scaleY)
            : (l.value = "h" == l.opt.orientation ? l.scaleX : l.scaleY),
          "h" == l.opt.orientation
            ? l.level.width(o(l.x, i) + "%")
            : l.level.height(o(l.y, n)),
          "function" == typeof l.opt.callback && l.opt.callback(l);
      }
    },
  }),
